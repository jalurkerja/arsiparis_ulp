<?php
	...
	$__appstitle				= "Aplikasi Database Arsip BP2IP - Tangerang";
	...
	function sebut_hari($date) {
		$day[1] = "Senin";	$day[2] = "Selasa";	$day[3] = "Rabu";
		$day[4] = "Kamis";	$day[5] = "Jumat";	$day[6] = "Sabtu";
		$day[7] = "Minggu";
		return $day[date("N",mktime(0,0,0,substr($date,5,2),substr($date,8,2),substr($date,0,4)))];
	}
	
	function namabulan(){
		$bln[1] = "Januari";	$bln[4] = "April";	$bln[7] = "Juli";		$bln[10] = "Oktober";
		$bln[2] = "Pebruari";	$bln[5] = "Mei";	$bln[8] = "Agustus";	$bln[11] = "Nopember";
		$bln[3] = "Maret";		$bln[6] = "Juni";	$bln[9] = "September";	$bln[12] = "Desember";
		return $bln;
	}
	
	function sebut_tanggal($date,$isbold = true){
		$tgl[1] = "satu";		$tgl[11] = "sebelas";			$tgl[21] = "dua puluh satu";	
		$tgl[2] = "dua";		$tgl[12] = "dua belas";			$tgl[22] = "dua puluh dua";	
		$tgl[3] = "tiga";		$tgl[13] = "tiga belas";		$tgl[23] = "dua puluh tiga";	
		$tgl[4] = "emapat";		$tgl[14] = "emapat belas";		$tgl[24] = "dua puluh empat";	
		$tgl[5] = "lima";		$tgl[15] = "lima belas";		$tgl[25] = "dua puluh lima";	
		$tgl[6] = "enam";		$tgl[16] = "enam belas";		$tgl[26] = "dua puluh enam";	
		$tgl[7] = "tujuh";		$tgl[17] = "tujuh belas";		$tgl[27] = "dua puluh tujuh";	
		$tgl[8] = "delapan";	$tgl[18] = "delapan belas";		$tgl[28] = "dua puluh delapan";	
		$tgl[9] = "sembilan";	$tgl[19] = "sembilan belas";	$tgl[29] = "dua puluh sembilan";	
		$tgl[10] = "sepuluh";	$tgl[20] = "dua puluh";			$tgl[30] = "tiga puluh";	
		$tgl[31] = "tiga puluh satu";
		
		$bln = namabulan();
		
		for($xx=2001;$xx<=2031;$xx++){
	...
	function format_tanggal ($tanggal,$mode="dbY",$withtime=false,$gmt7 = false) {
		if(substr($tanggal,0,10) != "0000-00-00" && $tanggal != ""){
			if($mode ==	"dbY"){
				$bln = namabulan();
				$tanggal = substr($tanggal,8,2)." ".$bln[substr($tanggal,5,2) * 1]." ".substr($tanggal,0,4);
			} else {
				$arr = explode(" ",$tanggal);
				$time = null;
