<?php
	...
	header("Content-Disposition: attachment;Filename=pemeriksaan_penawaran_pengadaan.doc");
	...
	array_push($arr2,sebut_hari($db->fetch_single_data("spk","pemeriksaan_tanggal",array("id"=>$spk_id))));
	array_push($arr2,sebut_tanggal($db->fetch_single_data("spk","pemeriksaan_tanggal",array("id"=>$spk_id))));
