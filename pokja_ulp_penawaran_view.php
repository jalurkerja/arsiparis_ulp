<?php
	...
	header("Content-Disposition: attachment;Filename=surat_permintaan_penawaran_harga_".$supplier_id.".doc");
	...
	array_push($arr1,"{penawaran_latest_at}");
	...
	array_push($arr2,format_tanggal($db->fetch_single_data("pokja_ulp","penawaran_latest_at",array("id"=>$pokja_ulp_id))));
	...
	echo str_replace($arr1,$arr2,read_file("htmls/doc_06_".$page.".html"));
?>