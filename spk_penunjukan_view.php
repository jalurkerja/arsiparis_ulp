<?php
	...
	$arr2 = array();
	array_push($arr2,$db->fetch_single_data("spk","undangan_nomor",array("id"=>$spk_id)));
	array_push($arr2,format_tanggal($db->fetch_single_data("spk","undangan_tanggal",array("id"=>$spk_id))));
	...
	array_push($arr2,sebut_hari($db->fetch_single_data("spk","undang_tgl",array("id"=>$spk_id))));
	array_push($arr2,format_tanggal($db->fetch_single_data("spk","undang_tgl",array("id"=>$spk_id))));
	array_push($arr2,substr($db->fetch_single_data("spk","undang_jam",array("id"=>$spk_id)),0,5));
	array_push($arr2,$db->fetch_single_data("spk","undang_tempat",array("id"=>$spk_id)));
