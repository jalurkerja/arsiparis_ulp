<?php
	...
	header("Content-Disposition: attachment;Filename=surat_pesanan_".$supplier_id.".doc");
	...
	$arr2 = array();
	array_push($arr2,$db->fetch_single_data("pokja_ulp","undangan_nomor",array("id"=>$pokja_ulp_id)));
	array_push($arr2,format_tanggal($db->fetch_single_data("pokja_ulp","undangan_tanggal",array("id"=>$pokja_ulp_id))));
	...
	array_push($arr2,sebut_hari($db->fetch_single_data("pokja_ulp","undang_tgl",array("id"=>$pokja_ulp_id))));
	array_push($arr2,format_tanggal($db->fetch_single_data("pokja_ulp","undang_tgl",array("id"=>$pokja_ulp_id))));
	array_push($arr2,substr($db->fetch_single_data("pokja_ulp","undang_jam",array("id"=>$pokja_ulp_id)),0,5));
	array_push($arr2,$db->fetch_single_data("pokja_ulp","undang_tempat",array("id"=>$pokja_ulp_id)));
