...
?>
	...
	<?=$f->input("add","Tambah","type='button' onclick=\"window.location='groups_add.php';\"");?>
	<?=$paging;?>
	...
	<?php foreach($groups as $no => $group){ ?>
		<?php
			$actions = "<a href=\"groups_edit.php?id=".$group["id"]."\">Ubah</a> |
						<a href='#' onclick=\"if(confirm('Are You sure to delete this data?')){window.location='?deleting=".$group["id"]."';}\">Hapus</a> |
