<?php
	...
	header("Content-Disposition: attachment;Filename=laporan_penawaran_pengadaan.doc");
	...
	array_push($arr2,sebut_hari($db->fetch_single_data("pokja_ulp","laporan_tanggal",array("id"=>$pokja_ulp_id))));
	array_push($arr2,sebut_tanggal($db->fetch_single_data("pokja_ulp","laporan_tanggal",array("id"=>$pokja_ulp_id))));
