<?php
	...
	$procurement_work_id = $db->fetch_single_data("ba_evaluasi_dok","procurement_work_id",array("id" => $_GET["id"]));
	$supplier_id = $db->fetch_single_data("ba_evaluasi_dok","supplier_id",array("id" => $_GET["id"]));
	...
	$harga = $db->fetch_single_data("ba_evaluasi_dok","harga",array("id" => $_GET["id"]));
	...
	echo str_replace($arr1,$arr2,read_file("htmls/doc_09_".$page.".html"));
?>