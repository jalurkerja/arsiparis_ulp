<?php
	...
	header("Content-Disposition: attachment;Filename=ba_pemasukan_penawaran_pengadaan.doc");
	...
	$arr1 = array();
	array_push($arr1,"{ba_pemasukan_nomor}");
	array_push($arr1,"{ba_pemasukan_tanggal}");
	...
	$arr2 = array();
	array_push($arr2,$db->fetch_single_data("pokja_ulp","ba_pemasukan_nomor",array("id"=>$pokja_ulp_id)));
	array_push($arr2,format_tanggal($db->fetch_single_data("pokja_ulp","ba_pemasukan_tanggal",array("id"=>$pokja_ulp_id))));
	...
	array_push($arr2,sebut_hari($db->fetch_single_data("pokja_ulp","ba_pemasukan_tanggal",array("id"=>$pokja_ulp_id))));
	array_push($arr2,sebut_tanggal($db->fetch_single_data("pokja_ulp","ba_pemasukan_tanggal",array("id"=>$pokja_ulp_id))));
