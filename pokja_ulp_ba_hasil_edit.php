...
<div class="bo_title">Ubah Berita Acara Hasil Pengadaan</div>
<script>
	function download_file(pokja_ulp_id){
		window.open("pokja_ulp_ba_hasil_view.php?pokja_ulp_id=" + pokja_ulp_id);
	}
</script>
<?php
	if(isset($_POST["save"])){
...
<?=$f->start("","POST","","enctype='multipart/form-data'");?>
	...
	<?=$f->input("btn_ba_pembukaan","Buat Laporan Hasil Pengadaan","type='button' onclick='window.location=\"pokja_ulp_laporan_add.php?pokja_ulp_id=".$_GET["id"]."\";'");?>
<?=$f->end();?>
<?php
	$ba_hasil_nomor = $db->fetch_single_data("pokja_ulp","ba_hasil_nomor",array("id" => $_GET["id"]));
	$ba_hasil_tanggal = $db->fetch_single_data("pokja_ulp","ba_hasil_tanggal",array("id" => $_GET["id"]));
	$ba_hasil_supplier_id = $db->fetch_single_data("pokja_ulp","ba_hasil_supplier_id",array("id" => $_GET["id"]));
...
<script>	
	...
	document.getElementById("ba_hasil_nomor").value = "<?=$ba_hasil_nomor;?>";
	document.getElementById("ba_hasil_tanggal").value = "<?=$ba_hasil_tanggal;?>";
	document.getElementById("supplier_id").value = "<?=$ba_hasil_supplier_id;?>";
